...
import esto.es.java.config.audit.AuditEventConverter;
import esto.es.java.domain.PersistentAuditEvent;
...
import static esto.es.java.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
