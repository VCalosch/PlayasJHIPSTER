...
import esto.es.java.config.Constants;
import esto.es.java.PlayasApp;
import esto.es.java.domain.Authority;
import esto.es.java.domain.User;
import esto.es.java.repository.AuthorityRepository;
import esto.es.java.repository.UserRepository;
import esto.es.java.security.AuthoritiesConstants;
import esto.es.java.service.MailService;
import esto.es.java.service.dto.UserDTO;
import esto.es.java.web.rest.errors.ExceptionTranslator;
import esto.es.java.web.rest.vm.KeyAndPasswordVM;
import esto.es.java.web.rest.vm.ManagedUserVM;
import esto.es.java.service.UserService;
